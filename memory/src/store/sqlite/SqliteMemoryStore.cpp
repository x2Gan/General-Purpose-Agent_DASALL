...
[[nodiscard]] StoreResult not_implemented_store_result(const std::string& feature_name) {
  return StoreResult::failure(contracts::ResultCode::RuntimeRetryExhausted,
                              feature_name + " not implemented yet");
}
...
StoreResult SqliteMemoryStore::insert_fact(const contracts::MemoryFact& fact) {
  (void)fact;
  return not_implemented_store_result("insert_fact");
}
...
StoreResult SqliteMemoryStore::supersede_fact(const std::string& old_fact_id,
  ...
  (void)old_fact_id;
  (void)new_fact_id;
  return not_implemented_store_result("supersede_fact");
}
...
StoreResult SqliteMemoryStore::insert_experience(
  ...
  (void)experience;
  return not_implemented_store_result("insert_experience");
}
...
StoreResult SqliteMemoryStore::quarantine_record(const std::string& object_type,
  ...
  (void)object_id;
  (void)reason;
  return not_implemented_store_result("quarantine_record");
}
