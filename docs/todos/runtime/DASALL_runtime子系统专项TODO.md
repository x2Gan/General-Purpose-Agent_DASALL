...
| RT-BLK-06 | 2026-04-22 | 部分解阻 | 仍待 RT-TODO-025 完成 CMake/test registration 与 `ctest -N` discoverability 接线 | RT-TODO-004 已冻结 runtime 测试拓扑与 caller fixture 规则；旧 smoke 语义已被设计侧降级，但实际测试入口仍待 Build 落盘 |
