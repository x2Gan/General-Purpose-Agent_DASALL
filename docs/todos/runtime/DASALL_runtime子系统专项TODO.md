...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RT-TODO-001 | Done | 补齐 AgentFacade supporting types 口径 | runtime 详设 6.24.3、8.1 | 6.24.3 `AgentInitRequest`/`AgentInitResult`/`HandleOptions`/`ResumeHandleRequest` 口径 | L0 | runtime 详设；本 TODO | `AgentInitRequest`、`AgentInitResult`、`HandleOptions`、`ResumeHandleRequest` | 文档一致性 | `rg -n "AgentInitRequest\|AgentInitResult\|HandleOptions\|ResumeHandleRequest" docs/architecture/DASALL_runtime子系统详细设计.md docs/todos/runtime/DASALL_runtime子系统专项TODO.md docs/todos/runtime/deliverables/RT-TODO-001-AgentFacade-supporting-types口径收敛.md` | 无 | RT-BLK-04 | 完成本任务 | docs/todos/runtime/deliverables/RT-TODO-001-AgentFacade-supporting-types口径收敛.md；更新后的 runtime 详设 | types 有职责、字段概要、落盘位置，可被后续 Build 任务引用 |
| RT-TODO-002 | Done | 补齐 SessionManager supporting types 口径 | runtime 详设 6.24.5、8.1 | 6.24.5 `SessionSnapshot`/`PendingInteractionState`/`TurnPersistPlan`/`ResumeSeed` 口径 | L0 | runtime 详设；本 TODO | `SessionSnapshot`、`PendingInteractionState`、`TurnPersistPlan`、`ResumeSeed` | 文档一致性 | `rg -n "SessionSnapshot\|PendingInteractionState\|TurnPersistPlan\|ResumeSeed" docs/architecture/DASALL_runtime子系统详细设计.md docs/todos/runtime/DASALL_runtime子系统专项TODO.md docs/todos/runtime/deliverables/RT-TODO-002-SessionManager-supporting-types口径收敛.md` | 无 | RT-BLK-04 | 完成本任务 | docs/todos/runtime/deliverables/RT-TODO-002-SessionManager-supporting-types口径收敛.md；更新后的 runtime 详设 | session supporting types 输入/输出语义明确，可被后续 Build 任务引用 |
| RT-TODO-003 | Done | 收敛 RuntimeDependencySet 与相邻模块 seam | runtime 详设 6.2、6.13、6.24.12、8.3 | 6.24.12 `RuntimeDependencySet` 组合根；6.13 相邻模块调用面 | L0 | runtime 详设；本 TODO | `RuntimeDependencySet`、fail-closed stub、null adapter | 文档一致性 | `rg -n "RuntimeDependencySet\|fail-closed stub\|null adapter\|public interface" docs/architecture/DASALL_runtime子系统详细设计.md docs/todos/runtime/DASALL_runtime子系统专项TODO.md docs/todos/runtime/deliverables/RT-TODO-003-RuntimeDependencySet-seam收敛.md` | 无 | RT-BLK-05 | 完成本任务 | docs/todos/runtime/deliverables/RT-TODO-003-RuntimeDependencySet-seam收敛.md；更新后的 runtime 详设 | seam 口径唯一，不再假设真实端口已 ready |
| RT-TODO-004 | Done | 收敛 runtime 测试拓扑与 caller fixture | runtime 详设 7、8.1、9.1、9.4 | 8.1 目录布局；9.1 测试矩阵；9.4 集成测试路径 | L0 | runtime 详设；本 TODO | `tests/unit/runtime/`、`tests/integration/agent_loop/`、caller fixture | 文档一致性 | `rg -n "tests/unit/runtime\|tests/integration/agent_loop\|RuntimeUnaryIntegrationTest\|RuntimeResumeIntegrationTest\|RuntimeSafeModeIntegrationTest" docs/architecture/DASALL_runtime子系统详细设计.md docs/todos/runtime/DASALL_runtime子系统专项TODO.md docs/todos/runtime/deliverables/RT-TODO-004-runtime测试拓扑与fixture收敛.md` | 无 | RT-BLK-06 | 完成本任务 | docs/todos/runtime/deliverables/RT-TODO-004-runtime测试拓扑与fixture收敛.md；更新后的 runtime 详设 | discoverability 和 fixture 边界稳定 |
...
| RT-TODO-006 | Done | 定义 RuntimeErrorCode 与 CancellationToken | runtime 详设 6.15、6.16、8.1；RT-TC013、RT-TC017 | 6.15.1 错误码分类表；6.16.2 取消令牌语义 | L3 | `runtime/include/RuntimeErrorCode.h`、`runtime/include/CancellationToken.h` | `RT_E_1xx`~`RT_E_6xx` 全码段枚举、`CancellationToken::cancel/is_cancelled/bind_deadline` | `RuntimeErrorCodeTest`、`CancellationTokenTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_unit_tests && ctest --test-dir build-ci -R "RuntimeErrorCodeTest\|CancellationTokenTest" --output-on-failure` | 005 | 无 | — | `runtime/include/RuntimeErrorCode.h`、`runtime/include/CancellationToken.h`、`tests/unit/runtime/RuntimeErrorCodeTest.cpp`、`tests/unit/runtime/CancellationTokenTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-006-RuntimeErrorCode与CancellationToken设计收敛.md` | error/cancel 公共面可编译且可测；码段不重叠；cancel 跨线程可见 |
| RT-TODO-007 | Done | 定义 IAgentFsm 与 StateTransitionTypes | runtime 详设 6.6、6.7.4、6.24.6 | 6.6 接口表；6.7.1 运行状态枚举；6.7.4 守卫表列定义 | L3 | `runtime/include/fsm/IAgentFsm.h`、`runtime/include/fsm/StateTransitionTypes.h` | `IAgentFsm::current_state/can_enter/transition/is_terminal`、`RuntimeState`(17态)、`StateTransitionRequest`、`StateTransitionOutcome`、`TransitionRejectionReason` | `AgentFsmTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_unit_tests && ctest --test-dir build-ci -R AgentFsmTest --output-on-failure` | 005 | 无 | — | `runtime/include/fsm/IAgentFsm.h`、`runtime/include/fsm/StateTransitionTypes.h`、`tests/unit/runtime/AgentFsmTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-007-IAgentFsm与StateTransitionTypes设计收敛.md` | 显式状态机输入/输出类型稳定；17 态枚举与详设 6.7.1 一致；非法转移具备结构化 rejection surface |
| RT-TODO-008 | Done | 定义 IBudgetController 与 BudgetDecision | runtime 详设 6.10、6.24.7；RT-TC005 | 6.24.7 接口表；6.10 配置映射表 | L3 | `runtime/include/budget/IBudgetController.h`、`runtime/include/budget/BudgetDecision.h` | `IBudgetController::initialize/consume/snapshot/can_continue/can_replan/can_call_tool`、`BudgetDecision`、`BudgetViolationClass` | `BudgetControllerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_unit_tests && ctest --test-dir build-ci -R BudgetControllerTest --output-on-failure` | 005、006 | 无 | — | `runtime/include/budget/IBudgetController.h`、`runtime/include/budget/BudgetDecision.h`、`tests/unit/runtime/BudgetControllerTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-008-IBudgetController与BudgetDecision设计收敛.md` | 预算公共面覆盖 token/turn/tool/replan/latency 五维；消费 RuntimeBudget/BudgetSnapshot 不重解释语义；超限具备结构化 rejection surface |
| RT-TODO-009 | Done | 定义 checkpoint/recovery include 面 | runtime 详设 6.20、6.24.8、6.24.9；RT-TC006、RT-TC016 | 6.24.9 CheckpointManager 接口表；6.24.8 RecoveryManager 接口表；6.20 版本兼容方案 | L2 | `runtime/include/checkpoint/ICheckpointManager.h`、`runtime/include/checkpoint/CheckpointBuildTypes.h`、`runtime/include/recovery/IRecoveryManager.h`、`runtime/include/recovery/ResumePlan.h` | `ICheckpointManager::build_checkpoint/save/load/validate/make_resume_plan`、`IRecoveryManager::evaluate/execute/apply`、`ResumePlan`、`CheckpointBuildRequest`、checkpoint version tag helpers | `CheckpointManagerTest`、`RecoveryManagerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_checkpoint_manager_unit_test dasall_runtime_recovery_manager_unit_test && ctest --test-dir build-ci -R "CheckpointManagerTest\|RecoveryManagerTest" --output-on-failure` | 005 | 无 | — | `runtime/include/checkpoint/ICheckpointManager.h`、`runtime/include/checkpoint/CheckpointBuildTypes.h`、`runtime/include/recovery/IRecoveryManager.h`、`runtime/include/recovery/ResumePlan.h`、`tests/unit/runtime/CheckpointManagerTest.cpp`、`tests/unit/runtime/RecoveryManagerTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-009-ICheckpointManager与IRecoveryManager设计收敛.md` | checkpoint/recovery 公共面与详设一致；含 version tag key 定义、resume reject surface 与 recovery admit/reject/escalate supporting types |
| RT-TODO-010 | Done | 定义 ISessionManager 与 session public types | runtime 详设 6.24.5、8.1 | 6.24.5 SessionManager 接口表；6.6 `ISessionManager` 方法建议 | L2 | `runtime/include/session/ISessionManager.h`、`runtime/include/session/SessionTypes.h` | `ISessionManager::load_session/prepare_turn/persist_turn/bind_checkpoint_ref/build_resume_seed`、`SessionSnapshot`、`PendingInteractionState`、`ResumeSeed`、request/result seam types | `SessionTypeSurfaceTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_session_type_surface_unit_test && ctest --test-dir build-ci -R SessionTypeSurfaceTest --output-on-failure` | 002、005 | 无 | — | `runtime/include/session/ISessionManager.h`、`runtime/include/session/SessionTypes.h`、`tests/unit/runtime/SessionTypeSurfaceTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-010-ISessionManager与SessionTypes设计收敛.md` | session public surface 有独立接口面测试；`TurnPersistPlan` 仍保持 module-local；resume seed 不越权承担 checkpoint compatibility |
| RT-TODO-011 | Done | 定义 IScheduler 与 SchedulerTicket | runtime 详设 6.14.4、6.24.10；RT-TC007、RT-TC013 | 6.24.10 Scheduler 接口表；6.14.4 队列背压表 | L2 | `runtime/include/scheduling/IScheduler.h`、`runtime/include/scheduling/SchedulerTicket.h` | `IScheduler::enqueue/acquire_worker/release_worker/backpressure_state`、`SchedulerTicket`、`SchedulerTicketRequest`、`WorkerLeaseBudget`、`SchedulerBackpressureState` | `SchedulerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_scheduler_surface_unit_test && ctest --test-dir build-ci -R "^SchedulerTest$" --output-on-failure` | 005、006 | 无 | — | `runtime/include/scheduling/IScheduler.h`、`runtime/include/scheduling/SchedulerTicket.h`、`tests/unit/runtime/SchedulerTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-011-IScheduler与SchedulerTicket设计收敛.md` | 调度公共面包含队列深度、overflow disposition 与 backpressure 输出口；worker ticket 直接绑定 `CancellationToken`；单测可验证前台拒绝、恢复 FailedSafe、维护 drop-oldest 与 worker saturation |

### 6.3 控制器与控制平面实现任务

| ID | 状态 | 任务标题 | 来源依据 | 设计锚点 | 粒度等级 | 代码目标 | 目标函数/接口/数据结构 | 测试目标 | 验收命令 | 前置依赖 | 阻塞项 | 解阻条件 | 交付物 | 完成判定 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RT-TODO-012 | Done | 实现 CheckpointStateMapper | runtime 详设 6.5.1、6.20、9.2；RT-TC016 | 6.5.1 CheckpointState↔FSM 映射表全量 | L3 | `runtime/src/checkpoint/CheckpointStateMapper.cpp` | `CheckpointStateMapper::to_checkpoint_state/can_resume_from` | `CheckpointStateMapperTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_checkpoint_state_mapper_unit_test && ctest --test-dir build-ci -R "^CheckpointStateMapperTest$" --output-on-failure` | 007、009 | 无 | — | `runtime/src/checkpoint/CheckpointStateMapper.h`、`runtime/src/checkpoint/CheckpointStateMapper.cpp`、`tests/unit/runtime/CheckpointStateMapperTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-012-CheckpointStateMapper设计收敛.md` | §6.5.1 全部映射规则自动覆盖；非法枚举值返回 nullopt；Failed/Succeeded/Unspecified resume 拒绝可断言 |
| RT-TODO-013 | Done | 实现 TransitionGuardTable | runtime 详设 6.7.4、9.2 | 6.7.4 状态转移守卫表全量 | L3 | `runtime/src/fsm/TransitionGuardTable.cpp` | `TransitionGuardTable::is_legal/get_guard/get_checkpoint_strategy` | `TransitionGuardTableTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_transition_guard_table_unit_test && ctest --test-dir build-ci -R "^TransitionGuardTableTest$" --output-on-failure` | 007 | 无 | — | `runtime/src/fsm/TransitionGuardTable.h`、`runtime/src/fsm/TransitionGuardTable.cpp`、`tests/unit/runtime/TransitionGuardTableTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-013-TransitionGuardTable设计收敛.md` | §6.7.4 全表合法/非法转移可二值断言；合法边 guard/checkpoint strategy 可查询；非法边不返回规则 |
| RT-TODO-014 | Done | 实现 AgentFsm | runtime 详设 6.7、6.24.6 | 6.24.6 AgentFSM 接口表；6.7.3 主状态迁移图 | L2 | `runtime/src/fsm/AgentFsm.cpp` | `AgentFsm::current_state/transition/is_terminal/can_enter` | `AgentFsmTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_agent_fsm_unit_test && ctest --test-dir build-ci -R "^AgentFsmTest$" --output-on-failure` | 007、013 | 无 | — | `runtime/src/fsm/AgentFsm.h`、`runtime/src/fsm/AgentFsm.cpp`、`tests/unit/runtime/AgentFsmTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-014-AgentFsm设计收敛.md` | Waiting/FailedSafe/Completed 等显式状态可真实推进；合法转移返回 checkpoint hint；非法转移拒绝含 rejection reason |
| RT-TODO-015 | Done | 实现 BudgetController | runtime 详设 6.10、6.16、6.24.7；RT-TC005 | 6.24.7 BudgetController 接口表；6.16.1 超时维度表 | L2 | `runtime/src/budget/BudgetController.cpp` | `BudgetController::initialize/consume/snapshot/can_continue/can_replan/can_call_tool` | `BudgetControllerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_budget_controller_unit_test && ctest --test-dir build-ci -R "^BudgetControllerTest$" --output-on-failure` | 006、008 | 无 | — | `runtime/src/budget/BudgetController.h`、`runtime/src/budget/BudgetController.cpp`、`tests/unit/runtime/BudgetControllerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-015-BudgetController设计收敛.md` | 五维预算 snapshot 可真实更新；tool/replan/latency/token 超限可稳定拒绝；`can_continue/can_replan/can_call_tool` 与 snapshot 一致 |
| RT-TODO-016 | Done | 实现 CheckpointManager | runtime 详设 6.20、6.24.9；RT-TC006、RT-TC016 | 6.24.9 CheckpointManager 接口表；6.20 版本校验方案 | L2 | `runtime/src/checkpoint/CheckpointManager.cpp` | `CheckpointManager::build_checkpoint/save/load/validate/make_resume_plan` | `CheckpointManagerTest`、`CheckpointStateMapperTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_checkpoint_manager_unit_test dasall_runtime_checkpoint_state_mapper_unit_test && ctest --test-dir build-ci -R "^(CheckpointManagerTest|CheckpointStateMapperTest)$" --output-on-failure` | 009、012 | 无 | — | `runtime/src/checkpoint/CheckpointManager.h`、`runtime/src/checkpoint/CheckpointManager.cpp`、`tests/unit/runtime/CheckpointManagerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-016-CheckpointManager设计收敛.md` | build/save/load/validate/resume plan 真实闭环；waiting state 含 pending_action；schema version reject 可测；`rt.schema_version`/`rt.fsm_state_enum_version`/`rt.budget_schema_version` tag 写入验证；checkpoint state 由 012 mapper 折叠并与 hint 一致 |
| RT-TODO-017 | Done | 实现 RecoveryManager | runtime 详设 6.11、6.17、6.24.8；RT-TC002、RT-TC014 | 6.24.8 RecoveryManager 接口表；6.17.2 retry_idempotency_token；6.11.1 Recovery Context 可见性边界表 | L2 | `runtime/src/recovery/RecoveryManager.cpp` | `RecoveryManager::evaluate/execute/apply` | `RecoveryManagerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_recovery_manager_unit_test && ctest --test-dir build-ci -R "^RecoveryManagerTest$" --output-on-failure` | 006、009、015、016 | 无 | — | `runtime/src/recovery/RecoveryManager.h`、`runtime/src/recovery/RecoveryManager.cpp`、`tests/unit/runtime/RecoveryManagerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-017-RecoveryManager设计收敛.md` | retry/replan/abort_safe/degrade admission 明确；retry 复用既有 `retry_idempotency_token`；replan 生成新 token；budget exhaustion 可升级到 degrade；apply 对 safe/degrade 路径输出 RT_E_510/RT_E_511 |
| RT-TODO-018 | Done | 实现 SessionManager | runtime 详设 6.24.5、9.4 | 6.24.5 SessionManager 接口表；9.4 集成测试路径 #3 resume | L2 | `runtime/src/session/SessionManager.cpp` | `SessionManager::load_session/prepare_turn/persist_turn/bind_checkpoint_ref/build_resume_seed` | `SessionManagerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_session_manager_unit_test && ctest --test-dir build-ci -R "^SessionManagerTest$" --output-on-failure` | 002、010、016 | 无 | — | `runtime/src/session/SessionManager.h`、`runtime/src/session/SessionManager.cpp`、`tests/unit/runtime/SessionManagerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-018-SessionManager设计收敛.md` | waiting state 与 checkpoint anchor 路径可二值验证；runtime-local fail-closed stub 下可测；`ResumeSeed` 只输出最小恢复事实，resume 集成语义在 RT-TODO-028 单独收口 |
| RT-TODO-019 | Done | 实现 Scheduler | runtime 详设 6.14.4、6.24.10；RT-TC007、RT-TC013、RT-TC015 | 6.14.4 队列背压与溢出策略表；6.14.2 锁顺序表 | L2 | `runtime/src/scheduling/Scheduler.cpp` | `Scheduler::enqueue/acquire_worker/release_worker/backpressure_state`、`queue_mutex_`、三类 priority queue、worker budget/backpressure 视图 | `SchedulerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_scheduler_surface_unit_test && ctest --test-dir build-ci -R "^SchedulerTest$" --output-on-failure` | 006、011 | 无 | — | `runtime/src/scheduling/Scheduler.h`、`runtime/src/scheduling/Scheduler.cpp`、`tests/unit/runtime/SchedulerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-019-Scheduler设计收敛.md` | 队列深度、overflow、worker saturation 与背压语义稳定；worker ticket 直接绑定 `CancellationToken`；实现显式使用 §6.14.2 的 L5 `queue_mutex_` 保护队列读写 |
| RT-TODO-020 | Done | 实现 AgentOrchestrator 骨架与 stub 主循环 | runtime 详设 6.8、6.9、6.24.4 | 6.24.4 AgentOrchestrator 核心内部阶段：preflight/main_loop/tool_round/recovery_round/terminalize | L2 | `runtime/src/AgentOrchestrator.cpp` | `AgentOrchestrator::run_once`（注入式 stub 下游端口） | `AgentOrchestratorSkeletonTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_agent_orchestrator_skeleton_unit_test && ctest --test-dir build-ci -R "^AgentOrchestratorSkeletonTest$" --output-on-failure` | 003、014 | 无 | — | `runtime/src/AgentOrchestrator.h`、`runtime/src/AgentOrchestrator.cpp`、`tests/unit/runtime/AgentOrchestratorSkeletonTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-020-AgentOrchestrator骨架设计收敛.md` | 五段主循环 topology 连通（使用 stub/null 端口）；真实 `AgentFsm` 推进可追踪；tool/recovery round 跳过或进入均可二值断言 |
| RT-TODO-021 | Done | AgentOrchestrator 全控制器集成 | runtime 详设 6.8、6.9、6.24.4、7；RT-TC015 | 6.24.4 全量执行流；6.14.2 锁顺序表 | L2 | `runtime/src/AgentOrchestrator.cpp` | `AgentOrchestrator::run_once/continue_from_checkpoint/handle_waiting_state`（接入全部控制器，仍使用 seam/stub 证明 runtime-local 闭环） | `AgentOrchestratorControllerAssemblyTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_agent_orchestrator_controller_assembly_unit_test && ctest --test-dir build-ci -R "^AgentOrchestratorControllerAssemblyTest$" --output-on-failure` | 015、016、017、018、019、020 | 无 | — | 更新后的 `runtime/src/AgentOrchestrator.h`、`runtime/src/AgentOrchestrator.cpp`、`tests/unit/runtime/AgentOrchestratorControllerAssemblyTest.cpp`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-021-AgentOrchestrator全控制器集成设计收敛.md` | direct success、tool->abort_safe、waiting->resume 三条 runtime-local 主路径可二值验证；符合 §6.14.2 锁顺序声明；本任务只证明 runtime-local 控制器装配成立，不外推真端口联调 ready |
| RT-TODO-022 | Done | 实现 SafeModeController | runtime 详设 6.21、6.24.11 | 6.21.1 降级触发分类表；6.21.2 声明式降级链 | L2 | `runtime/src/safety/SafeModeController.cpp` | `SafeModeController::evaluate_entry/evaluate_exit/current_mode` | `SafeModeControllerTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_safe_mode_controller_unit_test && ctest --test-dir build-ci -R "^SafeModeControllerTest$" --output-on-failure` | 006、017、021 | 无 | — | `runtime/src/safety/SafeModeController.h`、`runtime/src/safety/SafeModeController.cpp`、`tests/unit/runtime/SafeModeControllerTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-022-SafeModeController设计收敛.md` | timeout、budget、dependency unavailable、policy forbidden、recovery exhausted 的模式分类可单元验证；`evaluate_exit(...)` 仅在依赖、watchdog、operator、budget 全恢复时退回 Normal；safe mode 集成语义在 RT-TODO-030 单独收口 |
| RT-TODO-023 | Done | 实现 RuntimeTelemetryBridge、RuntimeEventBus、RuntimeHealthProbe 与 BackgroundMaintenance hooks | runtime 详设 6.12、6.18、6.21、6.23、6.24.12；RT-TC008、RT-TC019、RT-TC020、RT-TC021 | 6.12 可观测性设计表；6.18 关联 ID 所有权与传播；6.23 后台维护任务表；8.2 J4 health 与 Gate 收口 | L1/L2 | `runtime/src/telemetry/RuntimeTelemetryBridge.cpp`、`runtime/src/telemetry/RuntimeEventBus.cpp`、`runtime/src/health/RuntimeHealthProbe.cpp`、`runtime/src/maintenance/BackgroundMaintenanceHooks.cpp` | `RuntimeTelemetryBridge::emit_transition/emit_budget_reject/emit_recovery_reject/emit_safe_mode`、`RuntimeEventBus::publish/subscribe/dispatch_pending`、`RuntimeHealthProbe::collect_snapshot`、`BackgroundMaintenanceHooks::publish_idle_tick` | `RuntimeTelemetryBridgeTest`、`RuntimeEventBusTest`、`RuntimeHealthProbeTest`、`RuntimeBackgroundMaintenanceHookTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_runtime_event_bus_unit_test dasall_runtime_telemetry_bridge_unit_test dasall_runtime_health_probe_unit_test dasall_runtime_background_maintenance_hook_unit_test && ctest --test-dir build-ci -R "^(RuntimeEventBusTest|RuntimeTelemetryBridgeTest|RuntimeHealthProbeTest|RuntimeBackgroundMaintenanceHookTest)$" --output-on-failure` | 006、013、017、021、022 | 无 | — | `runtime/src/telemetry/RuntimeEventBus.h`、`runtime/src/telemetry/RuntimeEventBus.cpp`、`runtime/src/telemetry/RuntimeTelemetryBridge.h`、`runtime/src/telemetry/RuntimeTelemetryBridge.cpp`、`runtime/src/health/RuntimeHealthProbe.h`、`runtime/src/health/RuntimeHealthProbe.cpp`、`runtime/src/maintenance/BackgroundMaintenanceHooks.h`、`runtime/src/maintenance/BackgroundMaintenanceHooks.cpp`、`tests/unit/runtime/RuntimeEventBusTest.cpp`、`tests/unit/runtime/RuntimeTelemetryBridgeTest.cpp`、`tests/unit/runtime/RuntimeHealthProbeTest.cpp`、`tests/unit/runtime/RuntimeBackgroundMaintenanceHookTest.cpp`、`runtime/CMakeLists.txt`、`tests/unit/runtime/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-023-ObservabilityHealthMaintenance设计收敛.md` | 结构化字段统一且引用 RT_E_*；request_id、session_id、trace_id、turn_id、checkpoint_id 可贯通；transition/budget/recovery/safe mode 事实可统一发射；health、watchdog、background maintenance 不阻塞 Main Loop；EventBus 非审计 drop 与 audit 保留语义可单元验证 |

### 6.4 测试支撑、集成、兼容与 Gate 收口任务

| ID | 状态 | 任务标题 | 来源依据 | 设计锚点 | 粒度等级 | 代码目标 | 目标函数/接口/数据结构 | 测试目标 | 验收命令 | 前置依赖 | 阻塞项 | 解阻条件 | 交付物 | 完成判定 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| RT-TODO-024 | Done | Contracts 字段级与 checkpoint replay 兼容验证 | runtime 详设 6.5、6.20、9.3、附录 A；RT-TC006、RT-TC016、RT-TC018 | 6.5 核心对象与 contracts 对齐关系表；6.20 版本兼容方案；附录 A durable execution 改进项 | L2 | `tests/contract/checkpoint/`、`tests/fixtures/runtime/checkpoints/`、`tests/integration/agent_loop/RuntimeCheckpointReplayCompatibilityTest.cpp` | `RuntimeBudget`、`Checkpoint`、`ReflectionDecision`、`RecoveryRequest`、`RecoveryOutcome`、golden checkpoint fixtures、`ResumePlan` 稳定性 | `RuntimeBudgetContractTest`、`CheckpointFieldContractTest`、`ReflectionDecisionContractTest`、`RecoveryRequestContractTest`、`RecoveryOutcomeContractTest`、`RuntimeCheckpointReplayCompatibilityTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_contract_tests dasall_runtime_checkpoint_replay_compatibility_integration_test && ctest --test-dir build-ci -R "^(RuntimeBudgetContractTest|CheckpointFieldContractTest|ReflectionDecisionContractTest|RecoveryRequestContractTest|RecoveryOutcomeContractTest|RuntimeCheckpointReplayCompatibilityTest)$" --output-on-failure` | 009、016、017 | 无 | — | `tests/fixtures/runtime/checkpoints/replay_waiting_tool_v1.fixture`、`tests/fixtures/runtime/checkpoints/replay_waiting_tool_schema_v2.fixture`、`tests/fixtures/runtime/checkpoints/replay_waiting_tool_missing_pending_action.fixture`、`tests/fixtures/runtime/checkpoints/replay_terminal_succeeded_v1.fixture`、`tests/integration/agent_loop/CMakeLists.txt`、`tests/integration/agent_loop/RuntimeCheckpointReplayCompatibilityTest.cpp`、`tests/integration/CMakeLists.txt`、`docs/todos/runtime/deliverables/RT-TODO-024-CheckpointReplayCompatibility设计收敛.md` | shared contracts 字段无回退；同一 golden checkpoint fixture 反复加载时得到稳定的 `ResumePlan`、状态映射与 reject 语义；schema version mismatch、pending_action 缺失和 terminal checkpoint resume 都能显式拒绝 |
| RT-TODO-025 | Done | 接线 runtime unit、integration、fixture 测试拓扑并替换旧 smoke 语义 | runtime 详设 8.1、9.1、9.4；RT-TC010、RT-TC021、RT-TC022 | 8.1 目录布局；9.1 测试矩阵；9.4 集成测试路径 | L2 | `tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`tests/integration/CMakeLists.txt`、`tests/integration/agent_loop/CMakeLists.txt`、`tests/fixtures/runtime/`、`tests/unit/runtime/RuntimeControlPlaneSurfaceTest.cpp` | discoverability topology、control-plane surface smoke、fixture roots | `ctest -N`、`RuntimeControlPlaneSurfaceTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_unit_tests dasall_integration_tests && ctest --test-dir build-ci -N && ctest --test-dir build-ci -R RuntimeControlPlaneSurfaceTest --output-on-failure` | 004、005 | RT-BLK-06 | 完成 004 | `tests/unit/runtime/RuntimeControlPlaneSurfaceTest.cpp`、更新后的 `tests/unit/runtime/CMakeLists.txt`、`tests/unit/CMakeLists.txt`、`tests/integration/CMakeLists.txt`、`tests/integration/agent_loop/CMakeLists.txt`、`tests/fixtures/runtime/README.md`、`docs/todos/runtime/deliverables/RT-TODO-025-runtime测试拓扑与surface-gate收敛.md` | `RuntimeControlPlaneSurfaceTest` 通过，`RuntimeBuildLivenessSmokeTest` 仅保留 build-liveness 标签，且 `ctest -N` 可发现 runtime build-liveness、surface gate 与 integration 入口；聚合 `dasall_unit_tests` 构建仍受既有 `tests/unit/knowledge/FreshnessControllerStalePolicyTest.cpp` 语法损坏阻塞，但新增 runtime targets 已全部成功编译 |
| RT-TODO-026 | Done | 验证 RuntimeUnaryFixtureIntegration 主成功链 | runtime 详设 7、8.2 J1~J3、9.4、9.6；RT-TC021 | 9.4 集成测试路径 #1 的 runtime-local 变体；9.6 unary Gate 的 subsystem-local 层 | L2 | `tests/integration/agent_loop/RuntimeUnaryFixtureIntegrationTest.cpp` | unary runtime-local fixture chain：`AgentRequest -> Session/FSM/Budget/Checkpoint/Recovery -> AgentResult` | `RuntimeUnaryFixtureIntegrationTest`、`AgentOrchestratorSkeletonTest` | `cmake -S . -B build-ci -G "Unix Makefiles" && cmake --build build-ci --target dasall_integration_tests dasall_unit_tests && ctest --test-dir build-ci -R "(RuntimeUnaryFixtureIntegrationTest|AgentOrchestratorSkeletonTest)" --output-on-failure` | 021、023、024、025 | 无 | — | `runtime/src/AgentFacade.cpp`、`tests/fixtures/runtime/RuntimeUnaryFixture.h`、`tests/unit/runtime/RuntimeControlPlaneSurfaceTest.cpp`、更新后的 `tests/unit/runtime/CMakeLists.txt`、`tests/integration/agent_loop/CMakeLists.txt`、`tests/integration/agent_loop/RuntimeUnaryFixtureIntegrationTest.cpp`、`docs/todos/runtime/deliverables/RT-TODO-026-RuntimeUnaryFixtureIntegration设计收敛.md` | `RuntimeUnaryFixtureIntegrationTest`、`RuntimeControlPlaneSurfaceTest` 与 `AgentOrchestratorSkeletonTest` 全部通过；主链已真实经过 `AgentFacade -> AgentOrchestrator` 并返回 completed result / checkpoint anchor；该任务只证明 subsystem-local ready，不外推 true integration ready；聚合 `dasall_unit_tests` 仍继承 025 已知 knowledge 模块语法 blocker |
| RT-TODO-027 | Done | 验证 RuntimeUnaryIntegration 真端口成功链 | runtime 详设 7、8.2 J3、9.4、9.6；RT-TC011、RT-TC021 | 9.4 集成测试路径 #1 正常链路；9.6 RT-GATE-04 的 true integration 层 | L2 | `tests/integration/agent_loop/RuntimeUnaryIntegrationTest.cpp`、`runtime/src/AgentOrchestrator.cpp`、`cognition/src/CognitionFacade.cpp` | unary 真端口成功链：`AgentRequest -> ContextPacket -> cognition -> tools -> AgentResult` | `RuntimeUnaryIntegrationTest`、`MainFlowContractE2ETest` | `cmake --build build/vscode-linux-ninja --target dasall_runtime_unary_integration_test && ctest --test-dir build/vscode-linux-ninja -R "^RuntimeUnaryIntegrationTest$" --output-on-failure && ctest --test-dir build/vscode-linux-ninja -R "^MainFlowContractE2ETest$" --output-on-failure` | 026、023、024、025 | 无 | — | `tests/integration/agent_loop/RuntimeUnaryIntegrationTest.cpp`、`docs/todos/runtime/deliverables/RT-TODO-027-RuntimeUnaryIntegration设计收敛.md` | 主链已真实经过 runtime 与相邻模块 public interface；`RuntimeUnaryIntegrationTest` 与 `MainFlowContractE2ETest` 已通过；fixture gate 与 true integration gate 的分层证据留给 RT-TODO-031 统一回写 |
...
| RT-BLK-05 | 2026-04-22 | 已解阻 | RT-TODO-020、RT-TODO-021、RT-TODO-026 等依赖 seam 唯一性的装配与 fixture gate 任务 | RT-TODO-003 已冻结 RuntimeDependencySet、fail-closed stub、null adapter 与相邻模块 seam 的唯一规则 |
| RT-BLK-06 | 2026-04-22 | 已解阻 | runtime unit、integration 与 fixture discoverability 已完成接线；旧 smoke 已降级为 build-liveness-only | RT-TODO-025 已落盘 `RuntimeControlPlaneSurfaceTest`、顶层 runtime unit target 聚合、fixture root 说明与 integration fixture root 编译定义；`ctest -N` 已可发现 runtime build-liveness、surface gate 与 integration 入口 |
