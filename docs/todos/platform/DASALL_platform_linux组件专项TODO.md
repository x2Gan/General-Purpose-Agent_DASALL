...
| PLAT-LNX-TODO-022 | Done | 回写 platform/linux 门禁与交付证据 | platform 设计 9.2/11.1 | 9.2 Gate；11.1 阻塞管理 | L2 | docs/todos/platform/DASALL_platform_linux组件专项TODO.md | process test：门禁结果、阻塞变更、回退触发记录 | ctest --test-dir build-ci -N && ctest --test-dir build-ci --output-on-failure -L unit && ctest --test-dir build-ci --output-on-failure -R LinuxPlatformBootstrapIntegrationTest | PLAT-LNX-TODO-019~021 | 无 | 无 | 更新后的 TODO 文档证据段；2026-03-27 已回写全部 Gate 通过结论与命令证据，BLK-01/02/03/05 状态已收口，LinuxPlatformBootstrapIntegrationTest 1/1 Passed（双档），unit 23/23 Passed，构建门 ninja: no work to do | 仅当每个 Gate 都有通过/失败结论与命令证据时完成 |
...
### 7.3 剩余任务推进顺序（020-026，2026-04-08 评估更新）
...
4. docs/todos/platform/PLAT-LNX-TODO-001-PlatformInitConfig设计收敛.md：补齐 D 阶段设计收敛与 Design->Build 映射。
...
4. docs/todos/platform/PLAT-LNX-TODO-002-LinuxPlatformCapabilities设计收敛.md：补齐 D 阶段设计收敛与 Design->Build 映射。
...
5. docs/todos/platform/PLAT-LNX-TODO-003-PlatformError设计收敛.md：补齐 D 阶段设计收敛与 BLK-04 最小解阻证据。
...
4. docs/todos/platform/PLAT-LNX-TODO-004-IThread设计收敛.md：补齐 D 阶段设计收敛与 Design->Build 映射。
...
3. docs/todos/platform/PLAT-LNX-TODO-005-ITimer设计收敛.md：补齐 D 阶段设计收敛与 Design->Build 映射。
...
3. docs/todos/platform/PLAT-LNX-TODO-006-IQueue设计收敛.md：补齐 D 阶段设计收敛与 Design->Build 映射。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 7.3 R-1 明确要求补评审记录并回链 PLAT-LNX-TODO-008/016，完成后将 024 更新为 Done。
3. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 8 中 BLK-03 状态仍保留“待补评审记录”，需与 6.9.1 实际冻结状态对齐。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：将 PLAT-LNX-TODO-024 状态更新为 Done，并同步收口 R-1 与 BLK-03 描述。
...
1. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 7.3 R-2a 要求将 HalProbe.h + HalStub 最小接口正式回写设计文档并修正 BLK-01。
2. docs/architecture/platform_linux_detailed_design.md 既有内容已描述 HAL 桥接职责，但缺少“冻结到字段/返回码边界”的显式段落。
3. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 8 中 BLK-01 已写“最小探测接口已冻结”，但缺少在设计文档中的显式锚点。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：PLAT-LNX-TODO-023 更新为 Done；R-2a 更新为 Done；BLK-01 状态描述更新为“文档补票已完成、真实驱动留后续版本”。
...
1. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 7.3 R-2b 要求冻结 platform.linux.* 键名全集、注入入口与覆盖优先级，并修正 BLK-02。
...
3. docs/todos/platform/DASALL_platform_linux组件专项TODO.md 8 中 BLK-02 仍是“未统一”，需与设计冻结状态对齐。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：PLAT-LNX-TODO-025 更新为 Done；R-2b 更新为 Done；BLK-02 状态描述更新为“设计前置已解阻”。
...
5. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：更新 PLAT-LNX-TODO-020、R-3、BLK-05 及相关编排/阻塞描述。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：更新 PLAT-LNX-TODO-021 阻塞项、R-4 完成标志、BLK-02 状态。
...
2. docs/todos/platform/DASALL_platform_linux组件专项TODO.md：更新 TODO-021 为 Done；更新 R-5 行标为 Done；更新 F 阶段编排；新增本节执行记录。
...
1. Design -> Build 映射：仅更新文档（docs/todos/platform/DASALL_platform_linux组件专项TODO.md）。
2. Build 三件套：
