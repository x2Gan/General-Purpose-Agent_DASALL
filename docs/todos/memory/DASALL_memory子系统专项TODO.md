...
| C 生命周期与主存储基线 | MEM-TODO-011 ~ 015 | 011/012/013/014 已完成；015 依赖 014 | 已落 `MemoryManager` 生命周期骨架、`WorkingMemoryBoard` 核心、SQLite schema migration baseline 与 `SqliteMemoryStore` Session/Turn/Summary 主路径；下一步打开 Fact/Experience/maintenance 支持 |
...
1. MEM-TODO-001 ~ 007、008A、008B、009、009A、010、011、012、013、014、022、025 已完成；公共 ABI、测试拓扑、vector unavailable baseline、manager lifecycle skeleton、working-board 核心、schema migration baseline 与 store Session/Turn/Summary 主路径均已收口。
2. 再进入 MEM-TODO-015 ~ 021 的主链实现，按 Store -> Context -> Writeback 的顺序收口。
