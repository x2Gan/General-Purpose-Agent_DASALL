...
| L9 | docs/todos/contracts/WP-04-边界对象TODO.md | T015 完成判定要求覆盖 parent_request_id/goal_fragment/plan_fragment/guards/stop_conditions，并把协同字段约束程序化 |
...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T015 来源与三件套 | docs/todos/contracts/WP-04-边界对象TODO.md | WP04-T015 行 |
| MultiAgentRequest 对象边界 | docs/todos/contracts/deliverables/WP04-T014-MultiAgentRequest语义说明.md | §3/§4/§5/§6 |
| ADR-008 责任链与最小输入槽位 | docs/adr/ADR-008-agent-orchestrator-vs-multi-agent-coordinator.md | §3.2/§3.3/§4/§5.1 |
| T013 对 T014/T015 的影响结论 | docs/todos/contracts/deliverables/WP04-T013-ADR008对象影响清单.md | §3.1/§5 |
