...
- docs/todos/contracts/WP-04-边界对象TODO.md
...
| # | 来源 | 对 T022 的直接约束 |
|---|---|---|
| L1 | docs/todos/contracts/WP-04-边界对象TODO.md | T022 的目标是 ADR 到字段级约束映射表与自动检查守卫，输入基线为 T001-D 至 T021-D |
...
- docs/todos/contracts/deliverables/WP04-T022-ADR字段映射表.md
...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T022 目标与三件套 | docs/todos/contracts/WP-04-边界对象TODO.md | WP04-T022 行 |
| ADR-006 对象与禁止字段 | docs/todos/contracts/deliverables/WP04-T001-ADR006对象影响清单.md | §2/§3/§4 |
| ADR-007 对象与禁止字段 | docs/todos/contracts/deliverables/WP04-T006-ADR007对象影响清单.md | §3/§4/§5 |
| ADR-008 对象与禁止字段 | docs/todos/contracts/deliverables/WP04-T013-ADR008对象影响清单.md | §3 |
| WorkerTask 字段表基线 | docs/todos/contracts/deliverables/WP04-T019-WorkerTask字段表.md | §4/§5 |
| WorkerLease 字段表基线 | docs/todos/contracts/deliverables/WP04-T021-WorkerLease字段表.md | §4/§5 |
