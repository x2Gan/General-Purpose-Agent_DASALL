...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T018 来源与三件套 | `docs/todos/contracts/WP-04-边界对象TODO.md` | WP04-T018 行 |
| WorkerTask 影响项与最小槽位 | `docs/todos/contracts/deliverables/WP04-T013-ADR008对象影响清单.md` | §3.3 |
| WorkerTask 与 MultiAgentRequest 分层 | `docs/todos/contracts/deliverables/WP04-T014-MultiAgentRequest语义说明.md` | §5.3 |
| WorkerTask 与 MultiAgentResult 分层 | `docs/todos/contracts/deliverables/WP04-T016-MultiAgentResult语义说明.md` | §5.3 |
| 协同语义核对单 | `docs/todos/contracts/deliverables/WP01-T011-协同语义核对单.md` | §4.3 / §6 |
