...
| Prompt 边界禁区 | `docs/todos/contracts-freeze/deliverables/WP04-T001-ADR006对象影响清单.md` | §3 |
| PromptComposeRequest 4 必填 + 7 可选 | `docs/todos/contracts-freeze/deliverables/WP04-T002-PromptComposeRequest语义说明.md` | §2 |
| `context_packet_id` 引用模式 | `docs/todos/contracts-freeze/deliverables/WP04-T002-PromptComposeRequest语义说明.md` | §1.2 |
