...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T008 来源与三件套 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | WP04-T008 行 |
| ReflectionDecision 对象边界 | docs/todos/contracts-freeze/deliverables/WP04-T007-ReflectionDecision语义说明.md | §4/§5 |
...
| 仓内字段表模式 | docs/todos/contracts-freeze/deliverables/WP03-T013-Checkpoint字段表.md | §5.3 |
