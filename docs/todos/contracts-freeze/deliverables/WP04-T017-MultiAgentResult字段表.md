...
| L10 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | T017 完成判定要求覆盖 subtask_results/merged_result/conflicts/worker_trace_refs/recommended_next_action，并把字段口径程序化 |
...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T017 来源与三件套 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | WP04-T017 行 |
| MultiAgentResult 对象边界 | docs/todos/contracts-freeze/deliverables/WP04-T016-MultiAgentResult语义说明.md | §3/§4/§5/§6 |
| ADR-008 责任链与最小结果槽位 | docs/adr/ADR-008-agent-orchestrator-vs-multi-agent-coordinator.md | §3.2/§3.3/§4/§5.2 |
| T013 对 T016/T017 的影响结论 | docs/todos/contracts-freeze/deliverables/WP04-T013-ADR008对象影响清单.md | §3.2/§5 |
