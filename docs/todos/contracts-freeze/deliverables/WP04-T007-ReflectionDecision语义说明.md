...
| T006 允许语义与禁区 | docs/todos/contracts-freeze/deliverables/WP04-T006-ADR007对象影响清单.md | §3 |
| 建议权/执行权核对 | docs/todos/contracts-freeze/deliverables/WP01-T010-恢复语义核对单.md | §3 / §4 / §6 |
...
| T007/T008 边界划分 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | §4 / §5 |
