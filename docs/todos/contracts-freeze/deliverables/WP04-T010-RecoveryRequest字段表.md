...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T010 来源与三件套 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | WP04-T010 行 |
| RecoveryRequest 对象边界 | docs/todos/contracts-freeze/deliverables/WP04-T009-RecoveryRequest语义说明.md | §4/§5/§6 |
...
| Observation source/correlation 与 ErrorSourceRef 对齐 | docs/todos/contracts-freeze/deliverables/WP03-T007-Observation分类表.md | §5/§6/§7 |
| Checkpoint 三层字段守卫模式 | docs/todos/contracts-freeze/deliverables/WP03-T013-Checkpoint字段表.md | §5.3 |
| BudgetSnapshot 规则 | docs/todos/contracts-freeze/deliverables/WP02-T008-BudgetSnapshot规则.md | §4.2/§4.4 |
