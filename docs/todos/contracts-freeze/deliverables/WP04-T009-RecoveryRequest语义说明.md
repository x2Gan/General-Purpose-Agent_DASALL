...
| L8 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | T009-B 目标是 RecoveryRequest.h/Guards + contract test，完成判定是不退化为第二反思对象 |
...
| RecoveryRequest 影响项前置结论 | docs/todos/contracts-freeze/deliverables/WP04-T006-ADR007对象影响清单.md | §4 |
| ReflectionDecision suggestion-only 基线 | docs/todos/contracts-freeze/deliverables/WP04-T007-ReflectionDecision语义说明.md | §3 / §4 / §5 |
| ReflectionDecision 字段冻结基线 | docs/todos/contracts-freeze/deliverables/WP04-T008-ReflectionDecision字段表.md | §4 / §5 |
| Checkpoint retry_count 简化口径 | docs/todos/contracts-freeze/deliverables/WP03-T012-Checkpoint语义说明.md | §2.1 / §5 |
| RuntimeBudget / BudgetSnapshot 唯一预算表达 | docs/todos/contracts-freeze/deliverables/WP02-T007-RuntimeBudget字段清单.md；docs/todos/contracts-freeze/deliverables/WP02-T008-BudgetSnapshot规则.md | 预算冻结章节 |
| T009 来源与完成判定 | docs/todos/contracts-freeze/WP-04-边界对象TODO.md | WP04-T009 行 |
