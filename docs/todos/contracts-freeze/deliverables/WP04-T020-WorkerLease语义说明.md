...
> 任务编号：WP04-T020-D
> 上游输入：WP04-T013-D/B、WP04-T018-D/B、WP04-T019-D/B、ADR-008 §3.2/§3.3/§4/§5.4/§7、docs/architecture/DASSALL_Agent_architecture.md §3.8/§4.8/§5.11/§6.11/§6.12、docs/architecture/DASALL_Engineering_Blueprint.md §3.1/§3.10/§7.1、docs/plans/DASALL_contracts冻结实施计划.md §2/§7/§8、docs/plans/DASALL_工程落地实现步骤指引.md 阶段 B / 阶段 L、docs/todos/contracts-freeze/deliverables/WP02-T010-TimeDeadline规范.md
...
| 条款 | 文档路径 | 关键节 |
|---|---|---|
| T020 来源与三件套 | `docs/todos/contracts-freeze/WP-04-边界对象TODO.md` | WP04-T020 行 |
| WorkerLease 影响项与分层定位 | `docs/todos/contracts-freeze/deliverables/WP04-T013-ADR008对象影响清单.md` | §3.4 |
| WorkerTask 对租约语义的排除 | `docs/todos/contracts-freeze/deliverables/WP04-T018-WorkerTask语义说明.md` | §1.2 / §5.3 |
| WorkerTask 字段表的时间边界排除 | `docs/todos/contracts-freeze/deliverables/WP04-T019-WorkerTask字段表.md` | §1.2 / §5.3 |
| 协同语义核对单 | `docs/todos/contracts-freeze/deliverables/WP01-T011-协同语义核对单.md` | §3.1 / §6 |
...
| timeout 迁移与 deadline 优先 | `docs/todos/contracts-freeze/deliverables/WP02-T015-B1-timeout迁移清单.md` | §2 / §4 |
