...
| ContextPacket 引用模式 | docs/todos/contracts-freeze/deliverables/WP03-T010-ContextPacket语义说明.md | §2.1 |
| 禁区字段来源 | docs/todos/contracts-freeze/deliverables/WP04-T001-ADR006对象影响清单.md | §3 |
| 标识规范 | docs/todos/contracts-freeze/deliverables/WP02-T009-标识元数据规范.md | — |
| 时间规范 | docs/todos/contracts-freeze/deliverables/WP02-T010-TimeDeadline规范.md | — |
| 枚举规范 | docs/todos/contracts-freeze/deliverables/WP02-T012-枚举规范.md | — |
