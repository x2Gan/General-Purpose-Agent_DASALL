...
| WP05-T004-B | Not Started | 新增 ToolDescriptor/ToolIR 契约对象 | ToolDescriptor.h/ToolIR.h + contract test | 分层约束可自动验证 |
| WP05-T005-D | Not Started | 细化 PromptSpec 与 PromptRelease 对象 | deliverables/WP05-T005-PromptSpec-PromptRelease定义.md | 不回改 PromptComposeRequest/Result |
| WP05-T005-B | Not Started | 新增 PromptSpec/PromptRelease 契约对象与守卫 | PromptSpec.h/PromptRelease.h/Guards + contract test | Prompt 子域边界可验证 |
| WP05-T006-D | Not Started | 细化 Turn/Session/SummaryMemory 对象 | deliverables/WP05-T006-Memory对象定义.md | 与 SessionContext/Checkpoint 边界清晰 |
| WP05-T006-B | Not Started | 新增 Turn/Session/SummaryMemory 契约对象与守卫 | Turn.h/Session.h/SummaryMemory.h + contract test | 边界越权可检测 |
| WP05-T007-D | Not Started | 细化 MemoryFact/ExperienceMemory 对象 | deliverables/WP05-T007-记忆事实对象定义.md | 支持写回闭环且不污染主链路 |
| WP05-T007-B | Not Started | 新增 MemoryFact/ExperienceMemory 契约对象与守卫 | MemoryFact.h/ExperienceMemory.h + contract test | 主链路污染场景被阻断 |
| WP05-T008-D | Not Started | 细化 task 子域其余对象 | deliverables/WP05-T008-任务子域对象定义.md | 不越权承担顶层 Session/FSM 语义 |
| WP05-T008-B | Not Started | 新增 task 子域对象与越权守卫 | TaskDomainContracts.h/Guards + contract test | 顶层语义越权被阻断 |
| WP05-T009-D | Not Started | 细化 event 子域事件类型 | deliverables/WP05-T009-EventType-EventPayload设计稿.md | 封套与 payload 分层清晰 |
| WP05-T009-B | Not Started | 新增 EventType/EventPayload 契约对象与守卫 | EventType.h/EventPayload.h/Guards + contract test | 分层违规可检测 |
