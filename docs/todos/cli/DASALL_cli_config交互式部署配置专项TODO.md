...
| CLCFG-BLK-004 | 已部分解阻（2026-05-08）：`/usr/bin/dasall`、README/postinst/manpage 已落盘，但 autopkgtest smoke / installed-package validator 入口仍未全量落盘 | CLCFG-TODO-021、022 | packaging 提供完整 installed-package smoke 入口与 validator script | 在 CLCFG-TODO-021/022 中补齐 `debian/tests/pkg-smoke-local-control-plane` 与 `validate_cli_config_v1.sh` | 开发态可宣称 build-tree ready；installed-package ready 延后到 021/022 |
