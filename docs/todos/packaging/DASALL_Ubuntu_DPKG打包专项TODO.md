...
|---|---|---|---|
| 顶层与子模块 install surface | GNUInstallDirs + CLI/daemon system install naming 已建立，剩余 common assets install 仍缺 | PKG-TODO-007 | `debian/tmp` 可消费的标准安装面 |
