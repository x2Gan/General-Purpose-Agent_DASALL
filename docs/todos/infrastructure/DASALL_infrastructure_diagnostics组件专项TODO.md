...
| D 主链路骨架 | DIA-TODO-012、DIA-TODO-013、DIA-TODO-014、DIA-TODO-015、DIA-TODO-016、DIA-TODO-017 | 串行推进中 | 2026-04-07 已完成 DIA-TODO-012、DIA-TODO-013、DIA-TODO-014、DIA-TODO-015、DIA-TODO-016；下一步继续按 017 推进 |
...
3. 实现：SnapshotAssembler、SnapshotStore 当前可到类级骨架。
...
1. 直接推进 DIA-TODO-017，把 executor/evidence 的输出从 facade 中拆到真实 SnapshotAssembler。
2. 017 完成后回看是否需要收口 diagnostics 主链阶段的剩余 facade placeholder 逻辑与台账口径。
