...
3. 实现：ExportManager/Bridge 仍需先解相邻阻塞，SnapshotStore 已落盘最小持久化骨架。
...
1. 直接推进 DIA-BLK-005，冻结导出格式、checksum 与 allowed_targets 的 v1 边界。
2. DIA-BLK-005 解阻后进入 DIA-TODO-020 ExportManager，继续保持“先脱敏，再存储，再导出”的顺序。
