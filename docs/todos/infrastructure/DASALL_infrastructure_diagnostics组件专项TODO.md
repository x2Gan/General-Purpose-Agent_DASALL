...
| D 主链路骨架 | DIA-TODO-012、DIA-TODO-013、DIA-TODO-014、DIA-TODO-015、DIA-TODO-016、DIA-TODO-017 | 串行推进中 | 2026-04-07 已完成 DIA-TODO-012；继续按 Registry/Policy -> Executor -> Evidence -> Assembler 推进 |
...
1. 优先处理 DIA-BLK-003，冻结只读命令的完整参数 schema，然后推进 DIA-TODO-013。
2. DIA-TODO-014、DIA-TODO-015、DIA-TODO-016、DIA-TODO-017 可在 registry/blocker 收口后继续串行推进主链路骨架。
