...
适用范围：
1. docs/todos/infrastructure/DASALL_infrastructure子系统专项TODO.md
2. 12 份 infra 组件专项 TODO
3. docs/todos/platform/DASALL_platform_linux组件专项TODO.md
4. docs/todos/profiles/DASALL_profiles子系统专项TODO.md
...
| P3-S4 | 文档证据回写 | 更新各组件 TODO 的 gate 与阻塞变化 | 文档与命令结果一致 | rg -n "Gate|阻塞|回退" docs/todos/infrastructure/DASALL_infrastructure*专项TODO.md | 每个 gate 有结论与命令证据 |
