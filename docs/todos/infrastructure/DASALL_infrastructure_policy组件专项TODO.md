...
| docs/todos/infrastructure/DASALL_infrastructure子系统专项TODO.md INF-TODO-017/INF-BLK-07 | policy 已被列为 L2 可执行对象，但规则 schema 与冲突裁定顺序未冻结 | 本专项 TODO 必须显式承接 INF-BLK-07 |
