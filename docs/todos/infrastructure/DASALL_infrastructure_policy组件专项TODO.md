...
| F 观测桥接与集成 | POL-TODO-018~021 | 串行且局部受阻 | 018 已完成；019 已由 audit 接口冻结解阻可执行；020/021 仍受 POL-BLK-004 约束 |
