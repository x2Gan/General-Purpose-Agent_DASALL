...
| PluginManager | 详细设计 6.2、6.3、6.5、6.6、6.11 | 接口 / 流程 | INF-TODO-019、INF-BLK-09 | PluginDescriptor 与 IPluginManager 已冻结完成；2026-04-07 已补齐 manifest/signature/ABI 设计冻结，后续转入 plugin 对象与接口编码 |
...
| INF-BLK-08 | 已解阻（2026-03-30 校准）：INF-TODO-018 已落盘 IDiagnosticsService.h、DiagnosticsTypes.h 与首批 smoke/unit 证据，诊断命令白名单、请求/返回对象与远程导出默认门禁已有代码/测试回链 | diagnostics 子域 | INF-TODO-018 | 无；diagnostics 质量门证据已由 DIA-TODO-026 于 2026-04-07 统一回写；allowed_commands 参数 schema 已由 DIA-BLK-003 于 2026-04-07 解阻，RedactionEngine 规则矩阵已由 DIA-BLK-004 于 2026-04-07 解阻，导出格式/checksum/target 白名单已由 DIA-BLK-005 于 2026-04-07 解阻，bridge sink contract 已由 DIA-BLK-006 于 2026-04-07 解阻，CommandRegistry 白名单骨架与 unit 证据已由 DIA-TODO-013 于 2026-04-07 落盘，CommandPolicyGuard allow/deny skeleton 已由 DIA-TODO-014 于 2026-04-07 落盘，CommandExecutor success/failure skeleton 已由 DIA-TODO-015 于 2026-04-07 落盘，EvidenceCollector 聚合 skeleton 已由 DIA-TODO-016 于 2026-04-07 落盘，SnapshotAssembler 组装 skeleton 已由 DIA-TODO-017 于 2026-04-07 落盘，RedactionEngine strict/compat 脱敏骨架已由 DIA-TODO-018 于 2026-04-07 落盘，SnapshotStore retention/max_count 持久化骨架已由 DIA-TODO-019 于 2026-04-07 落盘，ExportManager 本地 jsonl/sha256/remote gate 骨架已由 DIA-TODO-020 于 2026-04-07 落盘，DiagnosticsMetricsBridge 七指标桥接骨架已由 DIA-TODO-021 于 2026-04-07 落盘，DiagnosticsAuditBridge required sink 审计骨架已由 DIA-TODO-022 于 2026-04-07 落盘，diagnostics 私有源码构建图收口已由 DIA-TODO-023 于 2026-04-07 完成，diagnostics unit / contract 测试发现性已由 DIA-TODO-024 于 2026-04-07 完成，diagnostics integration 发现性已由 DIA-TODO-025 于 2026-04-07 完成，DIA-TODO-026 已于 2026-04-07 统一回写 discoverability 14 项、unit 10/10、contract 2/2、integration 2/2 通过证据 | 证据回链到本节 8.1 校准记录，以及 infra/include/diagnostics/IDiagnosticsService.h、infra/include/diagnostics/DiagnosticsTypes.h、tests/unit/infra/DiagnosticsSnapshotExportTest.cpp、tests/integration/infra/InfraDiagnosticsSmokeTest.cpp |
| INF-BLK-09 | 已解阻（2026-04-07）：插件 manifest、ABI 兼容矩阵与签名链路已同步冻结 | plugin 子域 | plugin manifest/signature/compatibility 实现任务 | 无；后续按已冻结边界推进 plugin 对象与接口任务 | 证据回链到 plugin 详细设计 6.5.1/6.5.2/6.6.1、docs/todos/infrastructure/deliverables/PLG-BLK-01-03-INF-BLK-09-plugin对象与校验链路冻结.md 与 plugin 专项 TODO v1.14 |
...
| INF-BLK-08 | Resolved | 2026-03-30 | docs/architecture/DASALL_infra_diagnostics模块详细设计.md 6.6/6.9 已明确 IDiagnosticsService 语义、allowed_commands 与 remote.enabled 默认关闭；infra/include/diagnostics/IDiagnosticsService.h 与 infra/include/diagnostics/DiagnosticsTypes.h 已落盘 SnapshotQuery、SnapshotExportRequest、DiagnosticsSnapshotResult 与只读命令白名单；`ctest --test-dir build-ci -N -R "DiagnosticsSnapshotExportTest|InfraDiagnosticsSmokeTest"` 发现 2 个测试，`ctest --test-dir build-ci --output-on-failure -R "DiagnosticsSnapshotExportTest|InfraDiagnosticsSmokeTest"` 执行 2/2 通过；`ctest --test-dir build-ci -N | rg 'Diagnostics|InfraDiagnostics'` 发现 diagnostics 相关测试 14 项，`ctest --test-dir build-ci --output-on-failure -L unit -R 'Diagnostics|InfraDiagnostics'` 执行 10/10 通过，`ctest --test-dir build-ci --output-on-failure -L contract -R 'Diagnostics|InfraDiagnostics'` 执行 2/2 通过，`ctest --test-dir build-ci --output-on-failure -L integration -R 'Diagnostics|InfraDiagnostics'` 执行 2/2 通过 | diagnostics 专项中仅因 DIA-BLK-001 被标记为 Blocked 的任务应完成或转回 Not Started；DIA-BLK-003 已由 2026-04-07 的 schema 收敛轮解阻，DIA-BLK-004 已由 2026-04-07 的 redaction 规则矩阵收敛轮解阻，DIA-BLK-005 已由 2026-04-07 的导出格式与目标策略冻结轮解阻，DIA-BLK-006 已由 2026-04-07 的 bridge sink contract 收敛轮解阻，DIA-TODO-013 已于 2026-04-07 落盘 CommandRegistry 白名单骨架与 2 条 unit 证据，DIA-TODO-014 已于 2026-04-07 落盘 CommandPolicyGuard allow/deny skeleton，DIA-TODO-015 已于 2026-04-07 落盘 CommandExecutor success/failure skeleton，DIA-TODO-016 已于 2026-04-07 落盘 EvidenceCollector 聚合 skeleton 与新的 integration 证据，DIA-TODO-017 已于 2026-04-07 落盘 SnapshotAssembler 组装 skeleton 与 3 条定向测试证据，DIA-TODO-018 已于 2026-04-07 落盘 strict/compat 脱敏骨架与 4 条定向测试证据，DIA-TODO-019 已于 2026-04-07 落盘 SnapshotStore 持久化骨架与 3 条定向测试证据，DIA-TODO-020 已于 2026-04-07 落盘 ExportManager 本地 jsonl/sha256/remote gate 骨架与 5 条定向测试证据，DIA-TODO-021 已于 2026-04-07 落盘 DiagnosticsMetricsBridge 七指标骨架与 5 条定向测试证据，DIA-TODO-022 已于 2026-04-07 落盘 DiagnosticsAuditBridge required sink 审计骨架与 4 条定向测试证据，DIA-TODO-023 已于 2026-04-07 完成 diagnostics 私有源码构建图收口，DIA-TODO-024 已于 2026-04-07 完成 diagnostics unit / contract 发现性门禁，DIA-TODO-025 已于 2026-04-07 完成 diagnostics integration 发现性门禁，DIA-TODO-026 已于 2026-04-07 完成 diagnostics 质量门与交付证据统一回写；diagnostics 子域当前 Build-ready 任务与质量门证据均已收口 |
| INF-BLK-09 | Resolved | 2026-04-07 | docs/architecture/DASALL_infra_plugin模块详细设计.md 已新增 6.5.1 PluginManifest schema v1.0、6.5.2 SignatureReport/CompatibilityReport v1 与 6.6.1 签名信任链/ABI 兼容规则冻结；docs/todos/infrastructure/deliverables/PLG-BLK-01-03-INF-BLK-09-plugin对象与校验链路冻结.md 已回写本地证据、外部参考与 Design -> Build 映射；docs/todos/infrastructure/DASALL_infrastructure_plugin组件专项TODO.md 已把 014~017 从 Blocked 迁移为 Not Started | plugin 专项中的 PLG-TODO-014/015/016/017 可恢复为 Build-ready 串行任务；后续 blocker 仅剩 PluginRuntimeBridge 平台细节，不再阻塞对象/接口冻结 |
