...
| Gate-COG-FIX004A-02 | Pending | 待 COG-FIX-004A-BLD-003 ~ 004 | projector 未落地前，不宣称 structured payload 已具 typed projection 可信度 |
| Gate-COG-FIX004A-03 | Pending | 待 COG-FIX-004A-BLD-005 ~ 006 | Facade authoritative consumption 未落地前，local Planner / Reasoner 仍是现行主链 |
