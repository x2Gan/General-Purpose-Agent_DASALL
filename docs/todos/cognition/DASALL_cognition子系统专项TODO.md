...
| Gate-COG-FIX004A-04 | Pending | COG-FIX-004A-BLD-008 ~ 010；待 COG-FIX-004A-BLD-011 | runtime interaction、integration regression 与 telemetry fields 已具 focused evidence，safety negative matrix 仍待 build 证据 |
