...
| Gate-COG-12 | Changes Requested / Pending | COG-TODO-039 ~ 044；2026-05-15 在 `build-ci-cog042` 复验后确认：runtime smoke 与 cognition unit slice 通过，但统一 gate 仍被 runtime / llm / tools / infra / platform / profiles / apps-daemon 非 cognition blocker 阻断 | 在 repo-wide blocker 清零且 COG-TODO-043、044 完成前，不应宣称 cognition 具备完整可合并验收证据 |
...
| COG-R23 | Open | COG-TODO-042、043 已补齐 Gate-COG-12 与详设当前状态证据；仍待 COG-TODO-044 | 详设当前状态已与代码、专项 TODO、worklog 对齐；剩余开放项收敛为 cognition warning hygiene |
