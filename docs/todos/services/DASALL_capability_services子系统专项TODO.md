...
|---|---|---|---|---|---|
| CAP-BLK-001 | 已解阻：高风险 action taxonomy 与 require_confirmation 动作集合已在 6.6.1 / 9.4 成表；2026-05-21 `CAPSRV-FIX-007` 已把 caller-domain owner 收敛为 Tools / Access PolicyGate | 命令执行、审计、高风险 failure 注入 | CAP-TODO-015、016、024、030、031 | 2026-04-09 已完成 CAP-TODO-012，并与 execution_policy.requires_high_risk_confirmation / allowed_tool_domains 对齐；2026-05-21 已去除 services caller-domain dangling owner | 完成 CAP-TODO-012、CAPSRV-FIX-007 |
...
| CAP-RISK-002 | 高风险 action taxonomy 或 caller-domain owner 边界漂移 | High | 命令车道绕过已冻结确认映射，或后续改动重新把 caller-domain allowlist 下沉到 services | 保持 CAP-TODO-012 + `CAPSRV-FIX-007` 设计基线；新增高风险动作或 caller-domain owner 变更必须先回评审，再进入命令链实现 |
