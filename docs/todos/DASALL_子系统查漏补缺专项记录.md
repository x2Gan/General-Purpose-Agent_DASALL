...
5. 查漏补缺优先级：先收口 `KNO-GAP-003` / `KNO-GAP-004` / `KNO-GAP-005` / `KNO-GAP-007`，最后通过 `KNO-GAP-006` / `KNO-GAP-008` / `KNO-GAP-010` / `KNO-GAP-011` 提升 release 与边界可信度。
