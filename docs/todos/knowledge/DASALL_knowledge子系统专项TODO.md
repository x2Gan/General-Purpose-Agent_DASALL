...
| `tests/unit/knowledge/CMakeLists.txt` | 已注册 interface surface、config projection、telemetry、QueryNormalizer、CorpusRouter、Reranker、EvidenceAssembler、CorpusCatalog 与 FreshnessController unit targets | knowledge unit discoverability 与 public surface / query normalization / route planning / rerank / evidence assembly / catalog snapshot / freshness gate 已建立 |
