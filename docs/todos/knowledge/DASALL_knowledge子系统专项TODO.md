...
| 配置投影 | `KnowledgeConfigProjector`、`KnowledgeConfigSnapshot` | 6.10、6.13.6 | `knowledge/src/health/` 或 `knowledge/src/config/` | `KnowledgeConfigSnapshot` 已在 public surface 冻结；projector 未落盘 |
