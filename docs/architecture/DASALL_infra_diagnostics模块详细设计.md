...
10. docs/todos/DASALL_infrastructure子系统专项TODO.md（INF-TODO-018、INF-BLK-08）
...
| DIA-T010 | Not Started | 回写 infra 专项 TODO 对齐证据 | infra 专项 TODO 6/7/8/9 章 | docs/todos/DASALL_infrastructure子系统专项TODO.md | process gate | rg -n "INF-TODO-018|INF-BLK-08|Diagnostics" docs/todos/DASALL_infrastructure子系统专项TODO.md | 至少回写状态、命令证据、阻塞变化 |
