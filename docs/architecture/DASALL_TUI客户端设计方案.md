...
截至 2026-05-23，`apps/tui/src/ipc/TuiIpcController.h` 已落 header 草案：冻结五个 operation 的 request payload、response payload、`TuiIpcOutcome`、per-operation timeout policy 与 `TuiIpcController` 方法面；transport、serialization 与错误归一化仍继续后置到 `TUI-TODO-022`。
