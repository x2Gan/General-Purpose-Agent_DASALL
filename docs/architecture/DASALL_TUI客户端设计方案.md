...
| 当前实现成熟度 | Not Ready | 当前仓库已有 fake-only TUI substrate 与十八项 L2 基线，但 formal app/session/route/release path 仍未闭环；session open/close、真实状态投影、模型偏好真链路与命令迁移继续后置 |
