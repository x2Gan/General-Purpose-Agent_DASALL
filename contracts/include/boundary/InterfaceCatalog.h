...
inline constexpr std::array<InterfaceCatalogEntry, 10> kInterfaceCatalog = {{
    ...
    },
    {
        ...
        InterfaceAdmissionReadiness::AwaitingSupportingContracts,
        "Execution Service unified action semantics",
        "tools must call a stable execution facade instead of platform or remote-control details",
    },
    {
        ...
        InterfacePrimaryConsumer::Tools,
        InterfaceAdmissionReadiness::AwaitingSupportingContracts,
        "Blueprint IDataService file slot",
        "data capability is a shared service boundary, but its request/result contracts are not frozen yet",
    },
    {
