...
void test_tui_integration_local_cmake_registers_future_app_tests() {
  ...
  assert_true(local_cmake.find("TuiStatusPanelIntegrationTest") != std::string::npos,
              "tui integration CMake should register TuiStatusPanelIntegrationTest for discoverability");
  assert_true(local_cmake.find("TuiSessionLifecycleIntegrationTest") != std::string::npos,
  ...
  assert_true(local_cmake.find("TuiAppLoggingIntegrationTest") != std::string::npos,
              "tui integration CMake should register TuiAppLoggingIntegrationTest for discoverability");
  assert_true(local_cmake.find("TuiDaemonBackedE2ETest") != std::string::npos,
              "tui integration CMake should register TuiDaemonBackedE2ETest for discoverability");
  ...
  assert_true(local_cmake.find("DasallTuiScriptedSmokeTest") != std::string::npos,
              "tui integration CMake should register DasallTuiScriptedSmokeTest for discoverability");
  assert_true(local_cmake.find("DasallTuiSocketOverrideTest") != std::string::npos,
              "tui integration CMake should register DasallTuiSocketOverrideTest for discoverability");
