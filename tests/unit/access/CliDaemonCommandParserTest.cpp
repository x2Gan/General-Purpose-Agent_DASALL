...
void test_parse_run_and_submit_alias() {
  ...
  const char* run_argv[] = {"dasall-cli", "run", "{\"input\":\"hello\"}"};
  ...
  const char* submit_argv[] = {"dasall-cli", "submit", "{\"input\":\"hello\"}"};
...
void test_parse_status_and_cancel_arguments() {
  ...
  const char* status_argv[] = {
      "dasall-cli", "status", "receipt-031", "owner-token", "local://uid/1000"};
  ...
  const char* cancel_argv[] = {
      "dasall-cli", "cancel", "receipt-031", "owner-token"};
...
void test_parse_diag_and_missing_status_token_reject() {
  ...
  const char* diag_argv[] = {"dasall-cli", "diag", "snapshot.get"};
  ...
  const char* invalid_status_argv[] = {"dasall-cli", "status", "receipt-031"};
  ...
  const char* invalid_scope_argv[] = {
      "dasall-cli", "status", "--async", "receipt-031", "owner-token"};
  ...
  const char* duplicate_request_id_argv[] = {
      "dasall-cli", "run", "--request-id=req-1", "--request-id", "req-2", "{}"};
...
void test_parse_help_and_version_commands() {
  ...
  const char* default_help_argv[] = {"dasall-cli"};
  ...
  const char* explicit_help_argv[] = {"dasall-cli", "help", "diag", "health"};
  ...
  const char* help_flag_argv[] = {"dasall-cli", "run", "--help"};
  ...
  const char* version_argv[] = {"dasall-cli", "version", "--json", "--quiet"};
...
void test_reject_invalid_help_and_version_flag_combinations() {
  ...
  const char* help_json_argv[] = {"dasall-cli", "help", "--json"};
  ...
  const char* version_socket_argv[] = {
      "dasall-cli", "version", "--socket-path", "/tmp/dasall.sock"};
  ...
  const char* version_timeout_argv[] = {
      "dasall-cli", "version", "--timeout-ms", "50"};
...
void test_parse_socket_path_override_and_reject_invalid_forms() {
  ...
  const char* prefixed_argv[] = {
      "dasall-cli", "--socket-path", "/tmp/dasall/override.sock", "ping"};
  ...
  const char* suffixed_argv[] = {
      "dasall-cli", "status", "receipt-031", "owner-token",
  ...
  const char* duplicate_argv[] = {
      "dasall-cli", "--socket-path", "/tmp/dasall/a.sock",
  ...
  const char* missing_value_argv[] = {"dasall-cli", "--socket-path", "ping"};
  ...
  const char* default_argv[] = {"dasall-cli", "ping"};
