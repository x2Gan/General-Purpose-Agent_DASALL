...
void test_tui_unit_local_cmake_registers_future_focused_tests() {
  ...
  assert_true(local_cmake.find("TuiStatusProjectionContractTest") != std::string::npos,
              "tui unit CMake should register TuiStatusProjectionContractTest for discoverability");
  assert_true(local_cmake.find("TuiModelSelectorDaemonTest") != std::string::npos,
              "tui unit CMake should register TuiModelSelectorDaemonTest for discoverability");
  assert_true(local_cmake.find("TuiRouteCatalogProjectionTest") != std::string::npos,
              "tui unit CMake should register TuiRouteCatalogProjectionTest for discoverability");
