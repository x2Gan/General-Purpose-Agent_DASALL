...
ValidationResult validate_required_paths(const std::string& document) {
  static const std::vector<std::string> required_paths = {
      ...
      "model_profile.planning.route",
      "model_profile.planning.fallback_route",
      "model_profile.planning.streaming_enabled",
      "model_profile.execution",
      "model_profile.execution.route",
      "model_profile.execution.fallback_route",
      "model_profile.execution.streaming_enabled",
      "model_profile.reflection",
      "model_profile.reflection.route",
      "model_profile.reflection.fallback_route",
      "model_profile.reflection.streaming_enabled",
      "model_profile.response",
      "model_profile.response.route",
      "model_profile.response.fallback_route",
      "model_profile.response.streaming_enabled",
      "token_budget_policy",
